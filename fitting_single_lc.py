...
def run_mcmc_single_wl(input_param_dic, LC_dic, wl_id):
    ...
    if input_param_dic['visualization']:
        print "visualization selected as True\n"
        output_dir = input_param_dic['output_dir']
        visualize_chains.plot_single_wavelength(wl_id, LC_dic[wl_id].obj_mcmc, 
            LC_dic[wl_id].transit_model.sample_conditional, extra_burnin_steps=0, 
            theta_true=None, plot_transit_params=True, plot_hyper_params=True, 
