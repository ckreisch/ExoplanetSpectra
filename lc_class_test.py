...
print LC_dic
LC_15 = LC_dic['1.5'] # Instantiate Ligt Curve object of wavelength 1.5 using the LightCurve class dictionary
LC_35 = LC_dic['3.5'] # Instantiate Ligt Curve object of wavelength 3.5 using the LightCurve class dictionary
